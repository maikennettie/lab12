...
public class FamilyTree
{
    ...
    private static class TreeNode
    {
        ...
        TreeNode getNodeWithName(String targetName)
        {
            ...
            {
                TreeNode nodeName = child.getNodeWithName(targetName);
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0) {
			throw new TreeException("The : character cannot be found");
		}
		...
		for(int i = 0; i < childrenArray.length; i++) {
			TreeNode c = new TreeNode(childrenArray[i]);
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null) {
			throw new TreeException("A node for this input name cannot be found");
